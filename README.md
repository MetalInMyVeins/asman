...
| 6 | Take an arbitrary-length string from stdin, reverse it, and print the result | _ | _ |
| 7 | Take one arbitrary-length string from stdin, one from command line argument, concatenate them, store the result, and print the stored result | _ | _ |
