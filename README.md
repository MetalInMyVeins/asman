...
| 6 | Take n = array length from stdin, read n integers from stdin, and print twice of each element after input completion | _ | _ |
| 7 | Take a string (length limit = 256) from stdin, reverse it, and print the result | _ | _ |
| 8 | Take one string (length limit = 256) from stdin, one from command line argument, concatenate them, store the result, and print the stored result | _ | _ |
